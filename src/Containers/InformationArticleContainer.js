...
class InformationArticleContainer extends React.Component {

  componentDidMount() {
    let slug = this.props.match.params.slug;
    let id = this.props.match.params.id;
    axios.get(`https://admin.stoma.md/api/admin/info/categories/${slug}/${id}`)
      .then(response => {
...
let withUrlDataContainerComponent = withRouter(InformationArticleContainer);

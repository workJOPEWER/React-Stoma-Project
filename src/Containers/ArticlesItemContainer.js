...
class ArticlesItemContainer extends React.Component {

  componentDidMount() {
    let id = this.props.match.params.id;
    axios.get('https://admin.stoma.md/api/admin/articles/' + id)
      .then(response => {
...
let withUrlDataContainerComponent = withRouter(ArticlesItemContainer);
